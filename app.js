...
/* object that tracks issues in case of multiple failed requirements */
...
IssueTracker.prototype = {
  ...
  retrieve: function () {
    /* setCustomValidity expects an empty string if there are no conflicts */
    var message = "";
...
submit.onclick = function () {
  ...
  /* two independent issues tracker instances to control where the message appears to the users */
